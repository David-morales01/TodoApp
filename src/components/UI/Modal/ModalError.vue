...
const { closeModalError } = useTaskStore()
</script>
...
<template>
    <transition enter-active-class="ease-out duration-300" enter-class="opacity-0" enter-to-class="opacity-100"
        ...
        <div v-show="store.error" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                        ...
                        <div v-show="store.error"
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    ...
                                    <div class="mt-3 text-center text-red-500 sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3 class="text-lg  text-3xl leading-6 mt-2" id="modal-title">
                                            Error
                                        </h3>
                                        <div class="my-8">
                                ...
                                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    <button type="button" @click="closeModalError"
